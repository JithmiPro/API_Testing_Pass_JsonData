...
public class Merchant_Part7_Response {


    public String recordType  ;
    public String recordSequence  ;
    public String discountAmount  ;
    public String freightShippingAmount  ;
    public String dutyAmount  ;
    public String destinationPostalZIPcode  ;
    public String shipPostalZIPCode  ;
    public String destinationCountry  ;
    public String vatInvoiceReference ;
    public String orderDate  ;
    public String accountNumber  ;
    public String accountNumberExtension ;
    public String freightShippingVatTax  ;
    public String freightShippingVatTaxRate  ;
