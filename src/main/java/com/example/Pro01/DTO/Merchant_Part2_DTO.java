...
@Data
@NoArgsConstructor
public class Merchant_Part2_DTO {

    private String ruleTrn;
    ...
    private String recurringPmtFlag;
    private String recurringSeqNo;
    private String recurringRemark;
    private String requestToken;
    private String overrideReturnServiceURL;
    private String version;

    private String deviceType;
    private String ruleCom;
